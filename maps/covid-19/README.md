This script generates SVG maps of number of confirmed cases of COVID-19 per unit population by administrative division for various countries. Simply execute build.py.
